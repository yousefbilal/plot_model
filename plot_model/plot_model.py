    ...
    for i, layer in enumerate(layers):
        ...
        if not expand_nested or not isinstance(layer, Model):
            if color == True:
                ...
                elif rnn.findall(class_name_lower) or lstm.findall(class_name_lower) or gru.findall(
                        class_name_lower) or bidirectional.findall(class_name_lower):
